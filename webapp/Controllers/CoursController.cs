...
namespace webstor.Controllers
{
    public class CoursController : Controller
    {
        ...
        public IActionResult createcours(Models.model1.cours cours)
        {
            if (cours!=null)
            {
        ...
        public Models.model1.cours modelcours = new Models.model1.cours();
        ...
        public IActionResult Editt(Models.model1.cours cours1)
        {
            ...
            foreach (var item in cours1.idtechers)
            {
                if (item!=0)
                {
                    ...
                    beecours.Courss_techers = new List<techer_Cours>();
                    beecours.Courss_techers.Add(new techer_Cours { teacherId = teacher.id, courseId = item });
                }
            }
